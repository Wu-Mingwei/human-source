...
```
##Provide a assuming to incrase 5% salary to all employee to prevent the employee turnover. otherwise, we use the lowest salary to hire a new employee, and devoe timing consume to training as cost 40000.
```{r echo=FALSE}
